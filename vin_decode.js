const validate = vin => vin && vin.length === 17;
const countries = [
    {
        "code": "VF",
        "name": "France"
...
let dvin = vinDecoder(vin).decode()
if(dvin.manufacturer.toLowerCase().includes('volvo')){
    decodeVDS(dvin.year, 'volvo');
}


var vin = 'YV1RH527552446951';

console.log(vinDecoder(vin).decode())
